# S8 Docs / Governance / Contributor Onboarding — Backlog

---

## Now

- [x] `ROADMAP.md` — stream model + gate-based coordination
- [x] `LAUNCH.md` — precise launch definition
- [x] `STATUS.md` — dashboard
...
_(none — S8 runs in background)_
