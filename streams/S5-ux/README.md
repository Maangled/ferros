...
5. Keep new shared modules and route language aligned with `docs/orchestration/INTERCONNECTED-OPERATOR-UX-PLAN.md` and the discovery-note quarantine rules so visual motifs can land without importing unsafe paper-era claims.
