...
|----------|------|----------|--------|
| `Capability` type | Rust type | `crates/ferros-core/src/capability.rs` | ⬜ Not yet created |
| `PolicyEngine` trait | Rust trait | `crates/ferros-core/src/capability.rs` | ⬜ Not yet created |
...
|----------|--------|---------|
| `CapabilityGrant` | S2 | Policy engine evaluates grants; use stub until G2 |
