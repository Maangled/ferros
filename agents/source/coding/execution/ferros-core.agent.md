...
11. Internal recursion does not grant packet authority. Do not self-issue or self-update kickoff or continuation packets; send packet-request details back to Software Architect for FERROS Prompt Architect Agent construction.
