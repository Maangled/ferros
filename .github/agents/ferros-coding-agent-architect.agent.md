...
- Keep FERROS Coding Agent routing/handoff-first by default. Direct execution behavior requires a named exception case with evidence and a risk note.
...
- Invocation trigger: before FERROS Coding Agent relays a packet to Core/SubCore, or when a receiving side reports schema doubt.
...
continuity_baton:
  previous_owner: "FERROS Coding Agent|FERROS Core Agent|FERROS SubCore Agent"
  next_owner: "FERROS Coding Agent|FERROS Core Agent|FERROS SubCore Agent|FERROS Prompt Architect Agent"
...
continuity_baton:
  previous_owner: "FERROS Coding Agent"
