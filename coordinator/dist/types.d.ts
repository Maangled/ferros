...
export type LifecycleOutcomeKind = 'report' | 'work_order' | 'escalation' | 'denied' | 'archived' | 'stopped';
...
export interface SessionManagerOptions {
    sdk_client?: any;
    permission_handler?: (agent: string, request: any) => Promise<{
        approved: boolean;
    }>;
 ...
 */
export declare function isCoordinatorError(result: any): result is CoordinatorError;
/**
 * Type guard to check if result is execution return
 */
export declare function isExecutionReturn(result: any): result is ExecutionReturn;
